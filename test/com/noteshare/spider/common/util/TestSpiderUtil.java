...
public class TestSpiderUtil {
	...
	public void init(){
		...
		//以下是拿实时数据的路径
		//resParam = new RequestParams("http://d1.weather.com.cn/sk_2d/101190202.html?_=1481337487937",0,paramMap);
		//以下是拿生活指数数据的请求路径
	...
	@Ignore
	@Test
	public void getTodayDataTest() throws IOException{
	 ...
	 */
	@Test
	public void get7dDataTest() throws IOException{
		Document doc = SpiderUtil.getDocument(resParam,null);
		RealTimeService realTimeService = new RealTimeServiceImpl();
